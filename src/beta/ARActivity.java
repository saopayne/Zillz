...
import ui.gameviews.CameraPreview;
...
public abstract class ARActivity extends Activity implements SensorEventListener{
	...
	private void determineLightIntensity()
	{
		mSensorManager = (SensorManager)getSystemService(SENSOR_SERVICE);
	...
	public void onSensorChanged(SensorEvent sensorEvent) {
		...
		if (sensorType == Sensor.TYPE_ROTATION_VECTOR || sensorType == Sensor.TYPE_ROTATION_VECTOR) {
